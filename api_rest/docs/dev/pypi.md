...
ls dist/
# api_rest-1.2.3.tar.gz
# api_rest-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/api_rest-*.whl

# Verify installation
python -c "import api_rest; print(api_rest.__version__)"
...
1. Go to your project page: `https://pypi.org/project/api_rest/`
...
```bash
# View on PyPI
open https://pypi.org/project/api_rest/

# Install from PyPI
pip install api_rest
