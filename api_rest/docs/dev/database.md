...
Models are defined in the `api_rest/models` directory and inherit from the declarative base.
...
```python
from api_rest.services.db import get_session
...
python -m api_rest.www  # or celery, etc.
```
