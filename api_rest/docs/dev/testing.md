...
pytest --cov=./api_rest --cov-report=term-missing tests

# Generate HTML coverage report
pytest --cov=./api_rest --cov-report=html tests
# Open htmlcov/index.html in your browser

# Show coverage for specific file
pytest --cov=./api_rest/services/cache.py tests/services/test_cache.py
```
...
```python
@pytest.mark.asyncio
@patch('api_rest.services.cache.get_cached')
...
async def test_with_custom_env():
    ...
    from api_rest.settings import settings
...
def test_settings_load():
    ...
    assert settings.project_name == "api_rest"
...
pytest --cov=./api_rest --cov-fail-under=80 tests
```
