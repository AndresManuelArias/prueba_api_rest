...
- Installed with `pip install api_rest`
...
- Installed with `pip install api_rest[dev]`
...
# Creates:
# dist/api_rest-X.Y.Z.tar.gz (source)
# dist/api_rest-X.Y.Z-py3-none-any.whl (wheel)
```
